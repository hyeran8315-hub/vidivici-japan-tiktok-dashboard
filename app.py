...
st.markdown(
    ...
    <style>
        ...
        /* 체크박스 박스 자체 테두리 - 체크 여부와 상관없이 항상 보이게 */
        [data-testid="stCheckbox"] input + div {{
            border: 1.5px solid #F3EFE9 !important;
            background-color: transparent !important;
        }}

        /* 체크박스/토글 포인트 컬러를 베이지 톤으로 */
        ...
        [data-testid="stToggleSwitch"] [role="switch"][aria-checked="true"] > div {{
            background-color: {BEIGE} !important;
            border-color: {BEIGE} !important;
        }}
